...
This extension introduces a Table of Contents which can easily be added to a post. This feature only works with textile currently (as the ToC is generated to textile).
